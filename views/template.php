        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
	        	<div class="menuextras">
					<div class="extras">
						...
						<div class="form-group">
							<button type="submit" class="btn pull-right"><li><a href="<?= HOME; ?>/home/login">Login</a></li></button>
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
						<li class="logo-wrapper"><a href="<?= HOME; ?>"><img src="<?= HOME; ?>/assets/img/logo.png" alt="Multipurpose Twitter Bootstrap Template"></a></li>
						<li class="<?= ($viewData['menu'] == 'home')?'active':''; ?>">
                                                    <a href="<?= HOME; ?>">Home</a>
						</li>
						<li class="<?= ($viewData['menu'] == 'cadastro')?'active':''; ?>">
							<a href="<?= HOME; ?>/home/cadastro">Cadastre-se</a>
						</li>
						
						<li class="<?= ($viewData['menu'] == 'sobre')?'active':''; ?>">
							<a href="<?= HOME; ?>/home/sobre">Sobre</a>
						</li>
					</ul>
				</nav>
			</div>
